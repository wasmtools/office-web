...
// 构建版本号：每次发版更新此值，使 Service Worker 缓存名变化，
// 从而在 activate 时清除旧缓存（cacheFirst 策略下旧缓存不失效会导致
// 用户一直拿到修复前的旧 offline-shim.js 等文件）。需与 office.html 的
// __OO_BUILD_VERSION 保持一致。
