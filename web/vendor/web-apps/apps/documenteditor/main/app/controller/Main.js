            ...
            onLaunch: function() {
                ...
                if (this.api){
                    ...
                    if ( !Common.Utils.isIE ) {
                        if ( /^https?:\/\//.test('https://helpcenter.onlyoffice.com/userguides/docs-de.aspx') ) {
                            const _url_obj = new URL('https://helpcenter.onlyoffice.com/userguides/docs-de.aspx');
...
//                $(window.top).resize(_.bind(this.onDocumentResize, this));
                ...
                me.defaultTitleText = 'ONLYOFFICE';
                me.warnNoResources  = (me.warnNoResources || '').replace(/%1/g, 'ONLYOFFICE');
                me.warnNoLicenseUsers = (me.warnNoLicenseUsers || '').replace(/%1/g, 'ONLYOFFICE');
                me.textNoLicenseTitle = (me.textNoLicenseTitle || '').replace(/%1/g, 'ONLYOFFICE');
                me.textNoResourcesTitle = (me.textNoResourcesTitle || '').replace(/%1/g, 'ONLYOFFICE');
            },
...
//                    docInfo.put_Review(this.permissions.review);
            ...
            onSuggest: function() {
                window.open('https://feedback.onlyoffice.com/forums/966080-your-voice-matters?category_id=519084', "_blank");
            },
