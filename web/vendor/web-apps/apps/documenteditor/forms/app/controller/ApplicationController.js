...
define([
    ...
    DE.Controllers.ApplicationController = Backbone.Controller.extend(_.assign({
        ...
        onLaunch: function() {
            ...
            this.warnNoResources  = this.warnNoResources.replace(/%1/g, 'ONLYOFFICE');
            this.warnNoLicenseUsers = this.warnNoLicenseUsers.replace(/%1/g, 'ONLYOFFICE');
            this.textNoLicenseTitle = this.textNoLicenseTitle.replace(/%1/g, 'ONLYOFFICE');
            this.textNoResourcesTitle = this.textNoResourcesTitle.replace(/%1/g, 'ONLYOFFICE');
        },
